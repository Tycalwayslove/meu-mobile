 ...
 * @public
 */
export type PaginationDotsProps = Omit<
  ComponentProps<"div">,
...
> & {
  ...
  /** Disables every interactive page target without changing the read-only summary. */
  disabled?: boolean;
  ...
  maxVisible?: number;
  /** Called after an enabled, non-current page button is activated. */
