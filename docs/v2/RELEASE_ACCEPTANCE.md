...
| 官网         | 68 个组件页 × Light/Dark、共 136 个场景为最近全量浏览器基线；本批 Next 16 production build 与 81 个静态页面生成通过                                                |
| 单元与集成   | 当前工作树 `pnpm test` 19/19 个任务通过，其中 mobile 为 149 个文件、958/958 tests，form-react 为 19 个文件、70/70 tests；Next H5 移动双引擎 104/104 通过           |
