...
- 移动 Chromium/WebKit 隔离 Next H5：140/140 通过，逐用例断言 0 `pageerror`、0 `console.error`；其中性能/恢复专页 14/14，并完成 3 轮重复共 42/42；输入生命周期 8/8、嵌套浮层生命周期与全直接浮层边界矩阵 8/8、Popover placement/嵌套滚动容器 2/2、布局测量/hydration/CLS 8/8、真机验收工作台自检 2/2。
